require("which-key").setup {
  ...
  mappings = {
    ...
    -- ["f"] = { require("thekirer.telescope.custom-finders").find_project_files, "Find File" },
    ...
    L = {
      ...
      l = {
        name = "+logs",
        -- d = {
        --   "<cmd>lua require('thekirer.terminal').toggle_log_view(require('thekirer.log').get_path())<cr>",
        --   "view default log",
        -- },
        --   D = {
